            ...
            <ul className="space-y-4 w-full">
                {items.map((item, index) => (
                    <li
                        ...
                        className="text-brand-white font-bold flex items-center gap-3 text-sm md:text-base border-b border-white/10 pb-3 last:border-0 hover:text-brand-orange hover:translate-x-5 transition-all duration-500 cursor-pointer">
