...
export const Button = ({ children, onClick, variant = 'primary', className = '' }: ButtonProps) => {
 ...
 const baseStyles = "px-8 py-3 font-bold uppercase transition-all duration-300 active:scale-95 cursor-pointer rounded-2xl";

 const variants = {
 // Заменили text-brand-white на text-brand-white
