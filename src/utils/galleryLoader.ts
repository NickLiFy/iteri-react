...
export const getGalleryImages = (category: string) => {
 // Используем 'eager: true' для немедленной загрузки // и попробуем более широкий захват файлов
 ...
 // ВАЖНЫЙ ТРЮК: Мы ищем категорию в ключе. // В Vite после билда ключи могут выглядеть так: "/src/assets/gallery/topenarske-prace/..."
