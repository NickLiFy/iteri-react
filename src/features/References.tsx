...
export const References = () => {
 ...
 <div
 key={partner.name}
 className="group flex justify-center items-center h-24 px-5 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-pointer"
 >
 <img
 src={partner.img}
 alt={partner.name}
